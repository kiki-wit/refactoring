...
>챕터2에서는 그 이유를 설명한다. 사실 개발하면서 좋은 코드도 중요하지만 성능 또는 중요한 부분 중 하나로
>체감을 많이 느끼는 부분이기 때문에 성능을 고려하지 말라는 말은 어불성설같다는 생각이 들었었다. 
>챕터2에서는 리팩터링을 통해 성능을 개선할 수 있는 방법을 알려준다.
>내가 알고 있는 리팩터링에 대한 시야가 굉장히 좁았다는 것을 알 수 있었다. 
>
