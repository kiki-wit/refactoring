...
> 챕터1에서는 리팩터링을 하면서 성능은 신경쓰지 말라고 했다.<br/>
>챕터2에서는 그 이유를 설명한다. 사실 개발하면서 좋은 코드도 중요하지만 성능 또한 중요한 부분 중 하나로<br/>
...
>리팩터링을 사용하기 위한 굉장히 다양한 방식이 있다는 것을 알았고 <br/>
>내가 굉자히 좁은 시야로 알고 있었다는 것도 꺠달았다.
